...
public class WeatherResponseTest extends TestCase {
    public void testParcelable() {
        ...
        weatherResponse.writeToParcel(parcel, 0);

        parcel.setDataPosition(0);

        WeatherResponse weatherResponseFromParcel = WeatherResponse.CREATOR.createFromParcel(parcel);
        assertEquals(weatherResponse, weatherResponseFromParcel);
    }
}